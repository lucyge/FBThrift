 ...
 *
 */
public abstract class TPausableServer {

  /**
   * Core processor
   */
  protected final TPausableProcessorFactory processorFactory_;
  ...
  protected TPausableServer(TPausableProcessorFactory processorFactory,
