...
/**
 * <code>TMultiplexedPausableProcessor</code> is a <code>TPausableProcessor</code> allowing
 ...
 *
 * <blockquote><code>
 *     TMultiplexedPausableProcessor processor = new TMultiplexedPausableProcessor();
 *
 ...
 * </code></blockquote>
 */
public class TMultiplexedPausableProcessor implements TPausableProcessor {

    private final Map<String,TPausableProcessor> SERVICE_PROCESSOR_MAP
            = new HashMap<String,TPausableProcessor>();

    /**
     * 'Register' a service with this <code>TMultiplexedPausableProcessor</code>.  This
     ...
     */
    public void registerProcessor(String serviceName, TPausableProcessor processor) {
     ...
     */
    public boolean process(TProtocol iprot, TProtocol oprot, TConnectionContext server_ctx) throws TException, Pausable {
        /*
        ...
        */
        ...
        TPausableProcessor actualProcessor = SERVICE_PROCESSOR_MAP.get(serviceName);
        ...
        return actualProcessor.process(new StoredMessageProtocol(iprot, standardMessage), oprot, server_ctx);
    }

    public void setEventHandler(TProcessorEventHandler handler) {
        for (TPausableProcessor processor : SERVICE_PROCESSOR_MAP.values()) {
