...
class FiberCallbackBase : public RequestCallback {
  public:
    explicit FiberCallbackBase(
        std::shared_ptr<folly::fibers::Promise<Result, folly::fibers::Baton>> promise,
  ...
  protected:
    std::shared_ptr<folly::fibers::Promise<Result, folly::fibers::Baton>> promise_;
...
class HeaderFiberCallback
  ...
  public:
    HeaderFiberCallback(
        std::shared_ptr<folly::fibers::Promise<HeaderResult, folly::fibers::Baton>> promise,
        Processor processor,
        std::shared_ptr<apache::thrift::RequestChannel> channel = nullptr)
...
class OneWayFiberCallback : public FiberCallbackBase<folly::Unit> {
  public:
    explicit OneWayFiberCallback(
        std::shared_ptr<folly::fibers::Promise<folly::Unit, folly::fibers::Baton> promise,
        std::shared_ptr<apache::thrift::RequestChannel> channel = nullptr)
...
class FiberCallback<folly::Unit> : public FiberCallbackBase<folly::Unit> {
 ...
 public:
  FiberCallback(
      std::shared_ptr<folly::futures::Promise<folly::Unit, folly::fibers::Baton>> promise,
      Processor processor,
      std::shared_ptr<apache::thrift::RequestChannel> channel = nullptr)
